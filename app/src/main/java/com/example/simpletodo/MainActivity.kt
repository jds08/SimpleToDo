...
////            //Code in here is going to be executed to be executed when the user clicks on a button
...
//        }
        ...
        // and then set an on click listener
        findViewById<Button>(R.id.button).setOnClickListener {
            // 1. Grab the text the user has inputted in the @id/addTaskField
    ...
    // Save dat by writing an reading form file

    // Get the file
    fun getDataFile() : File {

        //Every line is going to represent a specific task in our tasks
